...
<body>
    ...
    <h2>Success</h2>
    <div class="valid-img"><img src="./imagefolder/light.png" width="70" height="70"/></div>
    <div class="buttonclass col-lg-12">
        <a href="<%=request.getContextPath()%>/employee/Employee.jsp"><button type="submit" class="btn btn-info">Ok</button></a>
    </div>
    </div>
</body>
</html>