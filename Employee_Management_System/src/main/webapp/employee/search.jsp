...
<div class="method">
    <label class="heading">Methods:</label>
    <label class="meth" for="contain">
        <input type="radio" name="md" id="contain" value="contains"/>
        <div class="con card">Contains</div>
    </label>
    <label class="meth" for="start">
        <input type="radio" name="md" id="start" value="startswith"/>
        <div class="con card">Starts with</div>
    </label>
    <label class="meth" for="end">
        <input type="radio" name="md" id="end" value="endswith"/>
        <div class="con card">Ends with</div>
    </label>
    <label class="meth" for="equals">
        <input type="radio" name="md" id="equals" value="equals"/>
        <div class="con card">Equals</div>
    </label>
    <label class="meth" for="not">
        <input type="radio" name="md" id="not" value="notequal"/>
        <div class="con card">Not Equals</div>
    </label>
</div>
</form>
<div class="container backtomenu">
<a href="Employee.jsp"><button type="submit"class="menubtn btn btn-info">Back to home</button></a>
</div>
</div>
</body>
</html>